/* folks-dummy.vapi generated by valac 0.20.1, do not modify. */
...
namespace Dummyf {
	...
	public class Backend : Folks.Backend {
		...
		public void register_persona_stores (Gee.Set<Dummyf.PersonaStore> stores, bool enable_stores = true);
		public override void set_persona_stores (Gee.Set<string>? store_ids);
		public override async void unprepare () throws GLib.Error;
		public void unregister_persona_stores (Gee.Set<Dummyf.PersonaStore> stores);
		public override bool is_prepared { get; }
		public override bool is_quiescent { get; }
		public override string name { get; }
		public override Gee.Map<string,Dummyf.PersonaStore> persona_stores { get; }
	}
	[CCode (cheader_filename = "folks/folks-dummy.h")]
	public class FatPersona : Dummyf.Persona, Folks.AntiLinkable, Folks.AvatarDetails, Folks.BirthdayDetails, Folks.EmailDetails, Folks.FavouriteDetails, Folks.GenderDetails, Folks.GroupDetails, Folks.ImDetails, Folks.LocalIdDetails, Folks.NameDetails, Folks.NoteDetails, Folks.PhoneDetails, Folks.RoleDetails, Folks.UrlDetails, Folks.PostalAddressDetails, Folks.WebServiceDetails {
		public FatPersona (Dummyf.PersonaStore store, string contact_id, bool is_user = false, string[] linkable_properties = new string[0] { });
	...
	public class Persona : Folks.Persona {
		...
		public Persona (Dummyf.PersonaStore store, string contact_id, bool is_user = false, string[] linkable_properties = new string[0] { });
		protected async void change_property (string property_name, Dummyf.Persona.ChangePropertyCallback callback);
	...
	public class PersonaStore : Folks.PersonaStore {
		public delegate void AddPersonaFromDetailsMock (Dummyf.Persona persona) throws Folks.PersonaStoreError;
		public delegate void PrepareMock () throws Folks.PersonaStoreError;
		public delegate void RemovePersonaMock (Dummyf.Persona persona) throws Folks.PersonaStoreError;
		...
		public void register_personas (Gee.Set<Dummyf.Persona> personas);
		public override async void remove_persona (Folks.Persona persona) throws Folks.PersonaStoreError;
		public void set_capabilities (Folks.MaybeBool can_add_personas, Folks.MaybeBool can_alias_personas, Folks.MaybeBool can_remove_personas);
		public void unregister_personas (Gee.Set<Dummyf.Persona> personas);
		public Dummyf.PersonaStore.AddPersonaFromDetailsMock? add_persona_from_details_mock { get; set; }
		...
		public override Gee.Map<string,Dummyf.Persona> personas { get; }
		public Dummyf.PersonaStore.PrepareMock? prepare_mock { get; set; }
		public Dummyf.PersonaStore.RemovePersonaMock? remove_persona_mock { get; set; }
